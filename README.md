...
* In this folder is [Spring Book](spring_book.pdf)
* Before doing this lab-walkthrough you must read Chapters 1 - 6
* The walkthough is the same application outlined in the book.
...
* Create a sub package of `com.stayready.poll_application` named `domain`.
